...
def _build_ecs_event(
    ...
    return {
        ...
        "user": {
            ...
            "email": email or f"{user_id}@example.com" if user_id else "unknown"
        },
        "labels": {k: str(v) for k, v in labels.items() if v is not None},
        "tags": ["saas-automation", "example-corp"]
    }
...
if __name__ == "__main__":
    ...
    test_events = [
        ...
        },
        {
            ...
            "action_required": "Manually remove bjones from example-corp org"
        }
    ]
