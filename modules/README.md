...
4. **Migrate users:** Move isaac/nicole from `administrators` to `developers` group
...
Refer back to the learning plan in `/Users/isaac/.claude/plans/stateless-tumbling-iverson.md`
