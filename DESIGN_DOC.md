...
- [ ] Secrets created in AWS Secrets Manager:
  ...
  - `jira-api-token` → `{"email": "admin@example.com", "api_token": "<token>"}`
...
**What it does NOT touch:** Existing IAM users (alice, bob, tf-user-alice, tf-user-bob), the administrators group, or any manually created resources.
