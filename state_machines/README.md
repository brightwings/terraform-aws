...
```json
{
  "execution_arn": "arn:aws:states:...:execution:onboarding:alice-20260217",
  "name": "alice-20260217",
  "status": "SUCCEEDED",
...
aws stepfunctions start-execution \
  ...
  --input '{"user_id": "test", "email": "test@example.com", "role": "developer", "systems": ["github"], "github_username": "testuser"}'
